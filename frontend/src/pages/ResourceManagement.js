...
const ResourceManagement = () => {
  ...
  useEffect(() => {
    const fetchResources = async () => {
      try {
        ...
        const res = await axios.get("https://georelief.onrender.com/api/resources", config);
    ...
    try {
      ...
      if (isEditing) {
        ...
        const res = await axios.put(
          `https://georelief.onrender.com/api/resources/${editingId}`,
          newResource,
          config
        );
        ...
        const res = await axios.post(
          "https://georelief.onrender.com/api/resources",
          newResource,
          config
        );
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      await axios.delete(`https://georelief.onrender.com/api/resources/${id}`, config);
